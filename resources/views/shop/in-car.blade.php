...
@section('title', __('shop.in_car_title'))
...
@section('content')
    ...
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl md:text-4xl font-extrabold flex items-center gap-3">
            <i class="fa-solid fa-car-side text-green-600"></i> {{ __('shop.in_car_title') }}
        </h1>
    ...
    <p class="text-text-muted mb-6">{{ __('shop.in_car_page_desc') }}</p>
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mb-8">
        ...
        @empty
            <div class="col-span-full text-center py-20">
                <i class="fa-solid fa-car text-6xl text-text-muted mb-4"></i>
                <p class="text-xl text-text-muted">{{ __('shop.in_car_empty') }}</p>
                <a href="{{ route('products.delivery') }}" class="inline-flex items-center gap-2 mt-4 text-amber-500 font-semibold hover:underline">
                    <i class="fa-solid fa-truck"></i> {{ __('shop.browse_delivery') }}
                </a>
            </div>
        @endforelse
    </div>
