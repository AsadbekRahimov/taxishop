    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <div x-data="{ open: false }" class="relative">
            <button @click="open = !open"
                ...
                <span>
                    @switch($sort)
                        @case('price_asc') По цене ↑ @break
                        @case('price_desc') По цене ↓ @break
                        @case('new') Новинки @break
            ...
            <div x-show="open"
                ...
                @foreach(['popular' => 'По популярности', 'price_asc' => 'По цене ↑', 'price_desc' => 'По цене ↓', 'new' => 'Новинки'] as $value => $label)
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mb-8">
        ...
        @empty
            <div class="col-span-full text-center py-20">
                ...
                <p class="text-xl text-text-muted">В этой категории пока нет товаров</p>
