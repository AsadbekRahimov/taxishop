...
<div class="w-full max-w-md mx-auto px-4">
    <div class="text-center mb-8">
        ...
        <p class="text-text-muted mt-2">Войдите для доступа к магазину</p>
    </div>
    ...
    <div class="bg-white rounded-2xl p-8 shadow-sm">
        <form method="POST" action="{{ url('/auth/login') }}">
            ...
            <div class="mb-5">
                <label for="login" class="block text-sm font-semibold text-text-muted mb-2">Логин</label>
                <input type="text"
                       id="login"
                       name="login"
                       value="{{ old('login') }}"
            ...
            <div class="mb-5">
                <label for="password" class="block text-sm font-semibold text-text-muted mb-2">Пароль</label>
                <input type="password"
                       id="password"
                       name="password"
            ...
            <div class="flex items-center mb-6">
                ...
                <label for="remember" class="ml-2 text-sm text-text-muted">Запомнить меня</label>
            </div>
